...
public class DDL {
    ...
    private static final String LOG_TABLE_STATEMENTS = "CREATE TABLE %1$s(ID CHAR(17) NOT NULL, TABLE_NAME VARCHAR2(256) NOT NULL, CRUD_TYPE VARCHAR2(10) NOT NULL, HISTORY_TYPE VARCHAR2(3) NOT NULL, DATA CLOB NOT NULL, INSERT_DATE DATE NOT NULL, CONSTRAINT %2$s_PK PRIMARY KEY (ID))";
